        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('categories[]', $categories, old('categories'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'required' => '']) !!}
            ...
            <div id="address-map-container" style="width:100%;height:200px; ">
                ...
                <script>
                    var map;
                    var default_center_latitude = {!! config('app.default_center_latitude') !!};
                    var default_center_longitude = {!! config('app.default_center_longitude') !!};
