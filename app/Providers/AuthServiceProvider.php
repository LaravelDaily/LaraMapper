...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Auth gates for: Stores
        Gate::define('store_access', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('store_create', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('store_edit', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('store_view', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('store_delete', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
